            ...
            return (
              <div key={message.id}>
                {message.role === "assistant" && (
                  <div className="flex gap-2 text-slate-600 text-sm mb-4">
                    <Avatar>
                    ...
                    <p className=" flex bg-slate-100 rounded p-4 items-center">{message.content}</p>
                  </div>
                )}

                {message.role === "user" && (
                  <div className="w-full flex gap-2 text-slate-800 text-sm justify-end mb-4">
                    <p className="bg-slate-300 rounded p-2">{message.content}</p>
